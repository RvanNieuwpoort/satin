...
public final class Stamp implements java.io.Serializable {
    ...
    /**
     * I found that there actually is no need to start with larger stamps
     * arrays. This is thanks to the order divide-and-conquer jobs are executed.
     */
     ...
     * 
     * @param parentStamp
     *            stamp of the spawner, or <code>null</code> if there is no
     *            parent.
     */
    ...
    /**
     * Constructor. Creates a new unique stamp from the specified parent stamp.
     * 
     * @param parentStamp
     *            stamp of the spawner, or <code>null</code> if there is no
     *            parent.
