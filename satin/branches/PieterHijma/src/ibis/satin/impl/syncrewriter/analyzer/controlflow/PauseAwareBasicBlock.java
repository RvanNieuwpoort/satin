...
class PauseAwareBasicBlock extends BasicBlock {
	...
	int indexPauseInstruction = cp.lookupMethodref("ibis.satin.SatinObject", "pause", "()V");
	if (indexPauseInstruction < 0) return false;
	return ih.getInstruction().equals(new INVOKESTATIC(indexPauseInstruction));
    }
