 ...
 * <code>SharedObject</code> class. This class exports one method that actually
...
public class SharedObject implements java.io.Serializable {
	...
	objectId = "SO" + sharedObjectsCounter + "@" + Satin.getSatin().ident;
    ...
    /**
     * Returns true if the shared object is still local. Write operations that
     * are done while the object is still local are not broadcasted. As soon as
     * an invocation record is made with this object, or exportObject is called,
     * the object is considered non-local.
     * 
     ...
     * participating in the application. This way, machines won't have to ask
     * for it later.
     */
