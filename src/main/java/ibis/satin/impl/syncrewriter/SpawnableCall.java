 ...
 */
public final class SpawnableCall {

    enum Type {
	NORMAL, RESULT_NOT_STORED, EXCEPTIONS_NOT_HANDLED
    };
     ...
     * 
     * @param index
     *            The index which is tested.
     * @return true if the spawnable call stores in a variable with index index;
     *         false otherwise.
     */
    ...
    SpawnableCall(InstructionHandle invokeInstruction,
	    InstructionHandle objectReference, Type type) {
	this.invokeInstruction = invokeInstruction;
	this.objectReference = objectReference;
