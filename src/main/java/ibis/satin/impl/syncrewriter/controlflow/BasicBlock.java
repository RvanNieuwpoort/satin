...
public class BasicBlock {
     ...
     * 
     * @param ih
     *            the instruction handle that will be tested
	...
	for (InstructionContext context : instructions) {
	    ...
	    sb.append(":\t");
	    sb.append(context.getInstruction().getInstruction()
		    .toString(methodGen.getConstantPool().getConstantPool()));
	    sb.append('\n');
	}
