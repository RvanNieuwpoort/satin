...
public class Debug {
     ...
     * 
     * @param turnOn
     *            indicates if debugging should be on or off
     * @param startLevel
     ...
     * @param arguments
     *            Arguments satisfying the format specifiers of the
     *            errorMessage.
     */
     ...
     * will be printed with indentation equal to level + the start level of this
     * debug instance.
     * 
     * @param level
     *            The level of indentation of the message
     * @param debugMessage
     *            The debugMessage to be printed.
     * @param arguments
     *            The arguments satisfying the format specifiers of the
     *            debugMessage.
     */
	...
	print("DEBUG: ", level + startLevel,
		String.format(debugMessage, arguments));
    }
	...
	if (sb.length() > NR_CHARS_ON_LINE) {
		...
		print(prefix, isFirstLine ? indentation + 2 : indentation,
			followingLines, !IS_FIRST_LINE);
	    }
