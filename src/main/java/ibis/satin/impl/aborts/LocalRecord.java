 ...
 * method. The Satin frontend generates a subclass of this class for each caller
 * of a spawnable method.
 */
abstract public class LocalRecord {
    /**
     * Deals with an exception or error which is raised by the Satin invocation
     * described by the parameters. This method gets called when a Satin job,
     * executed locally, throws an exception or error.
     * 
     * @param spawnId
     *            the identification of the spawned Satin invocation.
     * @param t
