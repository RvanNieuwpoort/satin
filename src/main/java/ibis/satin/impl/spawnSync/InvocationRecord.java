/* $Id: InvocationRecord.java 15353 2015-01-28 10:07:31Z ceriel $ */
 ...
 * each spawnable method. Of all fields, only the owner, the stamp and the
 * parent info must be sent over the network.
 */
public abstract class InvocationRecord implements java.io.Serializable, Config {
    ...
    /**
     * The machine that spawned this job. Used by my subclasses.
     */
    protected IbisIdentifier owner;

    /**
     * Used to locate this invocation record, when a remote job result comes in.
     */
    private Stamp stamp;
    ...
    /**
     * An id for the spawn in the code. Needed to run the correct inlet.
     */
    ...
    /**
     * Used for fault tolerance. True means that the job is an orphan
     **/
    ...
    /**
     * Determines if the specified invocation record is a descendent of the job
