/* $Id: Config.java 15353 2015-01-28 10:07:31Z ceriel $ */
...
public interface Config {
    ...
    static final String[] sysprops = { s_stats, s_queue_steals,
	    ...
	    s_throttle_steals, s_max_steal_throttle, s_cpt, s_cpt_push,
	    s_cpt_interval, s_cpt_first, s_cpt_file, s_cpt_maxFileSize,
	    s_cpt_quit, s_cpt_cluster };
     ...
     */
    static final boolean UNRELIABLE = properties.getBooleanProperty(
	    s_unreliable, false);
    ...
    /**
     * When set, every node decides for itself when checkpoints are sent to the
     * coordinator.
     */
    public static final boolean CHECKPOINT_PUSH = properties
	    .getBooleanProperty(s_cpt_push, true);

    /** Checkpointing interval, in milliseconds. */
    public static final int CHECKPOINT_INTERVAL = properties.getIntProperty(
	    s_cpt_interval, 60000);

    /** Time to wait before first checkpoint, in milliseconds. */
    public static final int CHECKPOINT_FIRST = properties.getIntProperty(
	    s_cpt_first, CHECKPOINT_INTERVAL);

    /** URI of the checkpoint file. */
    public static final String CHECKPOINT_FILE = properties.getProperty(
	    s_cpt_file, "checkpoints.txt");

    /** When set, this node is a candidate to become coordinator. */
    public static final boolean CHECKPOINT_CLUSTER = properties
	    .getBooleanProperty(s_cpt_cluster, true);

    /** If the checkpoint file becomes larger than this, compress (unless 0). */
    public static final int CHECKPOINT_MAXFILESIZE = properties.getIntProperty(
	    s_cpt_maxFileSize, 0);

    public static final int CHECKPOINT_QUITTIME = properties.getIntProperty(
	    s_cpt_quit, 0);
